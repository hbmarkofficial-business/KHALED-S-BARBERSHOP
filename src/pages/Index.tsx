  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | KHALED’S BARBERSHOP</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop KHALED’S BARBERSHOP in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="KHALED’S BARBERSHOP | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="KHALED’S BARBERSHOP | Premium Barbershop Berlin" />
        <meta
